...
function ModalLogin({ open, setIsOpenLogin, setIsOpenRegister } : { open: boolean, setIsOpenLogin: React.Dispatch<React.SetStateAction<boolean>>, setIsOpenRegister: React.Dispatch<React.SetStateAction<boolean>> }) {
