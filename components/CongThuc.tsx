...
function CongThuc() {
  return (
    <section className="relative bg-[url('/des-8-mobile.png')] lg:bg-[url('/des-8.png')] bg-[length:100%_100%]">
        ...
        <div className="absolute top-[48%] right-[20%] w-[12%] cursor-pointer hover:scale-110 duration-300 max-lg:hidden">
        ...
        <div className="absolute top-[48%] left-[20%] w-[12%] cursor-pointer hover:scale-110 duration-300 max-lg:hidden">
            ...
            <div className="flex flex-col items-center px-2 mt-[-20px]">
              <div className="flex items-center">
                <div className="relative flex justify-center items-center">
                  <Image src="/5@3x-8.png" alt="5@3x-8" width={120} height={120} className="transform animate-pulsate" />
                </div>
              ...
              <div className="flex items-center">
                <div className="relative flex justify-center items-center">
                  <Image src="/4@3x-8.png" alt="4@3x-8" width={120} height={120} className="transform animate-pulsate" />
                </div>
                <div className="flex items-center px-2 flex-1">
                  <span className="text-[#84571B] font-semibold text-justify">
                    <strong>OPO</strong> giúp hệ tiêu hóa vận hành tốt hơn, nhờ những tác động tích cực đến hệ sinh thái 100.000 tỷ vi khuẩn đường ruột. Đồng thời được bổ sung đặc biệt với lợi khuẩn Bifido-bacterium BB-12 và chất xơ (FOS+GOS).
              ...
              <div className="flex items-center">
                <div className="relative flex justify-center items-center">
                  <Image src="/1@3x-8.png" alt="1@3x-8" width={120} height={120} className="transform animate-pulsate" />
                </div>
                <div className="flex items-center px-2 flex-1">
                  <span className="text-[#84571B] font-semibold text-justify">
                    Cung cấp <strong>chất béo</strong> và <strong>năng lượng</strong> bền bỉ như 1 bữa ăn đầy đủ dinh dưỡng. <strong>Protein từ Đạm Whey thủy phân</strong> với kích thước siêu nhỏ dễ hấp thu & giảm tỉ lệ dị ứng sữa.
              ...
              <div className="flex items-center">
                <div className="relative flex justify-center items-center">
                  <Image src="/Artboard 19@3x-8.png" alt="Artboard 19@3x-8" width={120} height={120} className="transform animate-pulsate" />
                </div>
                <div className="flex items-center px-2 flex-1">
                  <span className="text-[#84571B] font-semibold text-justify">
              ...
              <div className="flex items-center">
                <div className="relative flex justify-center items-center">
                  <Image src="/2@3x-8.png" alt="2@3x-8" width={120} height={120} className="transform animate-pulsate" />
                </div>
                <div className="flex items-center px-2 flex-1">
                  <span className="text-[#84571B] font-semibold text-justify">
