  ...
  return (
    <section className="mb-8 bg-[bg-[#69dbe1] scroll-mt-24" id="trial-form">
      <div className="px-4 py-8 max-w-6xl m-auto bg-[url('/dki3.webp')] md:bg-[length:100%_100%]  bg-center rounded-[50px]">
        <div className="mb-8">
          <h2 className="text-[#002A9E] text-4xl uppercase text-center font-bold">ĐĂNG KÝ THAM GIA DANCE CHALLENGE</h2>
        </div>
        <div className="flex">
          <div className="w-full px-4">
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <p className="text-[#002A9E] italic">Hãy liên hệ chuyên gia dinh dưỡng theo số <strong>0978488123</strong> (miễn phí gọi đến) để được tư vấn thêm</p>
